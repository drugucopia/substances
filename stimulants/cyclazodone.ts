...
export const cyclazodone: Substance = 
{
  "id": "cyclazodone",
  "name": "Cyclazodone",
  "commonNames": [
  ...
  "effects": {
    ...
    "negative": [
      "Increased heart rate - Cyclazodone is reported to elevate heart rate to a greater degree than amphetamine.",
      ...
      "Dehydration",
      "Nausea - Typically a result of dosing for prolonged periods of time and dehydration.",
      "Teeth grinding - This component is reported to be less intense compared toMDMA, and only prominent when dosing for prolonged periods of time.",
