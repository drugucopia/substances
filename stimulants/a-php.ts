...
export const a_php: Substance = 
{
  ...
  "effects": {
    ...
    "negative": [
      ...
      "Psychosis - This compound may induce psychosis if it is compulsively binged upon for prolonged periods of time. However, the likelihood of psychosis on this compound has been reported to be noticeably less than that of A-PVP.",
      "Anxiety",
      "Cognitive fatigue",
      "Delusion",
      "Depression",
