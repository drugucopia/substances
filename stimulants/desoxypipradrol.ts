...
export const desoxypipradrol: Substance = 
{
  "id": "desoxypipradrol",
  "name": "Desoxypipradrol",
  "commonNames": [
  ...
  "effects": {
    ...
    "negative": [
      ...
      "Increased heart rate - Early reports suggest that the effects of desoxypipradrol on heart rate and blood pressure are unusually weak.",
