...
export const tyrosine: Substance = 
{
  "id": "tyrosine",
  "name": "Tyrosine",
  "commonNames": [
  ...
  "effects": {
    ...
    "negative": [
      ...
      "Headache - This effect is usually only present at heavy doses",
      "Nausea - This effect is usually only present at heavy doses",
      "Cognitive fatigue",
      "Anxiety",
      "Depression",
      "Irritability"
...
"history": null,
  ...
  "riskLevel": "low",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Tyrosine",
  "psychonautWikiUrl": "https://psychonautwiki.org/wiki/Tyrosine"
};