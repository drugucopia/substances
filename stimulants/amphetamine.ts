...
export const amphetamine: Substance = 
{
  "id": "amphetamine",
  "name": "Amphetamine",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Cognitive euphoria",
      "Cognitive enhancement - This is more potent in individuals with Attention-Deficit-Hyperactivity-Disorder",
    ...
    "neutral": [
      ...
      "Illusion - Many individuals admit to a dream-like state of mind whilst under the influence to the point of being surprised they were awake and not sleeping under the influence.",
      "Bronchodilation",
      "Frequent urination",
      ...
      "Reflex syncope - This may be experienced due to an Effect:Abnormal heartbeat causing a sudden loss in blood pressure.",
      "Cognitive impairment - This is paradoxical and involves perceiving reality actually happening and poorer IQ test results in some individuals.",
      "Dream suppression"
    ],
    "negative": [
      ...
      "Color Enhancement and Suppression - Amphetamine can dampen perception of the colors green and blue, enhance general color perception in some individuals.",
...
"history": "Amphetamine was first synthesized in Germany in 1887 by the Romanian chemist Lazăr Edeleanu, who named it phenylisopropylamine. In late 1933, Smith, Kline and French began selling amphetamine in the form of a decongestant inhaler under the name Benzedrine. Benzedrine sulfate was introduced 3 years later and was used to treat a wide variety of medical conditions, including narcolepsy, obesity, low blood pressure, low libido, and chronic pain.",
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Amphetamine",
