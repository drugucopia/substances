...
export const _3_fea: Substance = 
{
  ...
  "effects": {
    "positive": [
      ...
      "Empathy, affection, and sociability enhancement - This effect is reportedly very significant, with dosages in the common range and above often reportedly having this effect occur at a significance in line with that of a common dosage of MDMA.",
      "Cognitive euphoria",
      "Increased music appreciation - This effect is often reported as being a prominent effect at all dosages.",
      "Increased libido",
    ...
    "neutral": [
      ...
      "Pupil dilation - This effect is often very significant at even lower common dosages and the significance at common dosages has been described as being in line with that of a standard dosage of MDMA. This effect can also reportedly continue long after the duration of the main effects of the substance have subsided. The significance of this effect is thought to be attributable to the significant amount of serotonin that 3-FEA releases.",
      "Ego inflation",
    ...
    "negative": [
      ...
      "Abnormal heartbeat",
      "Dry mouth",
      "Diarrhea - 3-FEA has been reported to produce a laxative effect in some users.",
      ...
      "Appetite suppression - This effect can reportedly continue long after the duration of the main effects of the substance have subsided.",
