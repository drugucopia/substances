...
export const gabapentin: Substance = 
{
  "id": "gabapentin",
  "name": "Gabapentin",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Pain relief - Gabapentin is used to control pain, particularly fibromyalgic/neuropathic pain (nerve pain) and restless leg syndrome. It is generally considered to be not very effective for the management of acute pain, unlike opiates."
    ],
    "neutral": [
