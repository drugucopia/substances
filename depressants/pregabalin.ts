...
export const pregabalin: Substance = 
{
  "id": "pregabalin",
  "name": "Pregabalin",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Seizure suppression - Pregabalin is effective at reducing certain types of seizures such as focal seizures and partial seizures."
    ],
    "neutral": [
