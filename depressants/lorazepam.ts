...
export const lorazepam: Substance = 
{
  "id": "lorazepam",
  "name": "Lorazepam",
  "commonNames": [
  ...
  "harmReduction": [
    "Lorazepam likely has a low toxicity relative to dose. However, it is Toxicity potentially lethal when mixed with depressants like alcohol or opioids.",
