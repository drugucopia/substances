...
export const temazepam: Substance = 
{
  "id": "temazepam",
  "name": "Temazepam",
  "commonNames": [
  ...
  "harmReduction": [
    ...
    "Still, temazepam has a low toxicity relative to dose. However, it is Toxicity potentially lethal when mixed with depressants like alcohol or opioids.",
