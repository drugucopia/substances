...
export const secobarbital: Substance = 
{
  "id": "secobarbital",
  "name": "Secobarbital",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      "Muscle relaxation",
      "Physical euphoria  - Compared to other GABAergic depressants, this effect is particularly strong.",
    ...
    "neutral": [
      ...
      "Slurred speech - At higher doses, secobarbital is known to cause slurred speech.",
    ...
    "negative": [
      "Motor control loss",
      "Decreased libido",
      "Acuity suppression - Like many depressants, high doses of secobarbital may cause blurred vision.",
      "Compulsive redosing",
      "Dizziness",
  ...
  "legality": "Controlled substance: Schedule II (US), Class B (UK), Schedule III (UN), Prescription-only (EU/CA/AU)",
  "chemistry": {
    "formula": "C12H18N2O3",
    "molecularWeight": "238.28 g/mol",
    "class": "Barbiturates"
  },
    "aliases": [],
"history": null,
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Secobarbital",
  "psychonautWikiUrl": "https://psychonautwiki.org/wiki/Secobarbital"
};