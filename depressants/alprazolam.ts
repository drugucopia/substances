...
export const alprazolam: Substance = 
{
  "id": "alprazolam",
  "name": "Alprazolam",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Visual acuity suppression - Like many depressants, alprazolam is known to cause blurred or otherwise suppressed visual acuity.",
      "Dream potentiation",
    ...
    "negative": [
      ...
      "Dry mouth - Although infrequent, Alprazolam is capable of causing a dry mouth in some users. This may make a user drink more water. This is not the same as dehydration, as it is not known to be dangerous.",
