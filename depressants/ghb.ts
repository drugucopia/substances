...
export const ghb: Substance = 
{
  ...
  "harmReduction": [
    ...
    "It is recommended to dilute GHB with a non-alcoholic liquid in the ratio of at least 1:100 (e.g., 200ml of water for 2ml of GHB), in order to avoid potential burns to the intestines and mouth.",
    ...
    "To avoid a possible overdose of GHB, it is important to start with a low dose and work your way up slowly by increasing the dosage in small increments. While a common recreational dose is 2g, a dose of 5g - 10g can result in convulsions, unconsciousness and vomiting. Doses above 10 grams are associated with a risk of death. Recreational users must also consider the different potency of different GHB preparations available on the illicit market. Thus, even an experienced user should start with a lower than normal dose, if trying a new product for the first time.",
  ...
  "legality": "Controlled substance: Schedule I (US), Class B (UK), Schedule IV (UN), Controlled (EU/CA/AU)",
  "chemistry": {
    "formula": "C4H8O3",
