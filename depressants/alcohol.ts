...
export const alcohol: Substance = 
{
  "id": "alcohol",
  "name": "Alcohol",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Double vision - This effect increases in proportion to dose and can make driving or operating machinery impossible.",
      ...
      "After images - This effect may present itself at higher doses.",
      "Ego inflation",
    ...
    "negative": [
      ...
      "Suppressions or Enhancements - While alcohol is technically capable of both enhancing and suppressing auditory stimuli, it generally suppresses it, although some users note that sounds appear enhanced and markedly louder while under the influence.",
      "Motor control loss",
      "Skin flushing",
      "Acuity suppression",
      "Compulsive redosing",
...
"history": "History and culture of alcoholic drinks\nAlcohol was brewed as early as 7000 to 6650 BCE in northern China. Pliny the Elder wrote about the golden age of winemaking in Rome, the second century BCE, when vineyards were planted. In vino veritas is a Latin phrase that means \"in wine there is truth.\"",
  ...
  "riskLevel": "very-high",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Alcohol",
