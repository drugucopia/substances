...
export const flubromazolam: Substance = 
{
  "id": "flubromazolam",
  "name": "Flubromazolam",
  "commonNames": [
  ...
  "harmReduction": [
    "Flubromazolam likely has a low toxicity relative to dose. However, it is Toxicity potentially lethal when mixed with depressants like alcohol or opioids.",
