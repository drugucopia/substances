...
export const nifoxipam: Substance = 
{
  "id": "nifoxipam",
  "name": "Nifoxipam",
  "commonNames": [
  ...
  "harmReduction": [
    "Nifoxipam likely has a low toxicity relative to dose. However, it is Toxicity potentially lethal when mixed with depressants like alcohol or opioids.",
