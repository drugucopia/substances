...
export const flubromazepam: Substance = 
{
  "id": "flubromazepam",
  "name": "Flubromazepam",
  "commonNames": [
  ...
  "harmReduction": [
    "Flubromazepam likely has a low toxicity relative to dose. However, it is Toxicity potentially lethal when mixed with depressants like alcohol or opioids.",
