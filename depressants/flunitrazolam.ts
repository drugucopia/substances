...
export const flunitrazolam: Substance = 
{
  "id": "flunitrazolam",
  "name": "Flunitrazolam",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      "Muscle relaxation - Muscle relaxation can be quite pronounced"
    ],
    "neutral": [
  ...
  "harmReduction": [
    "Flunitrazolam likely has a low toxicity relative to dose. However, it is Toxicity potentially lethal when mixed with depressants like alcohol or opioids.",
...
"history": null,
  ...
  "riskLevel": "low",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Flunitrazolam",
  "psychonautWikiUrl": "https://psychonautwiki.org/wiki/Flunitrazolam"
};