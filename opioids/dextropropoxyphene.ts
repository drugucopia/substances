...
export const dextropropoxyphene: Substance = 
{
  "id": "dextropropoxyphene",
  "name": "Dextropropoxyphene",
  "commonNames": [
  ...
  "legality": "Controlled substance: Schedule II (US), Class B (UK), Schedule II (UN), Prescription-only (EU/CA/AU) - withdrawn from market in many countries",
  "chemistry": {
    "formula": "C22H29NO2",
    "molecularWeight": "339.50 g/mol",
    "class": "Phenylpropylamine"
  },
    "aliases": [],
"history": null,
  ...
  "riskLevel": "very-high",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Dextropropoxyphene",
