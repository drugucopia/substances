...
export const fentanyl: Substance = 
{
  ...
  "harmReduction": [
    ...
    "Fentanyl is very potent and around 1000 times more permeable than morphine. Even though fentanyl uptake through skin is rather slow, unintentionally transporting the substance from the skin by touching the mouth, nose or eyes is dangerous.",
    ...
    "As with other opioids, the chronic use of fentanyl can be considered extremely addictive with a high potential for abuse and is capable of causing psychological and physical dependence among certain users. When addiction has developed, cravings and may occur if a person suddenly stops their usage.",
