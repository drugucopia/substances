...
export const hydrocodone: Substance = 
{
  "id": "hydrocodone",
  "name": "Hydrocodone",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Dream potentiation",
      "Sleepiness",
      "Sedation - At higher dosages, this compound can result in feelings of sedation but is considerably less sedating than that of codeine, oxycodone or heroin.",
