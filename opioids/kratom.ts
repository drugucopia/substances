...
export const kratom: Substance = {
  ...
  interactions: {
    ...
    unsafe: [],
    uncertain: ["MAOIs", "Nitrous", "PCP", "Stimulants"],
    crossTolerances: ["opioids"],
  },
  harmReduction: [
    ...
    "As with other opioids, the kratom produces dependence with chronic use and has a high abuse potential. When dependence has developed, cravings and may occur if a person suddenly stops their usage.",
  ...
  legality:
    "Legal status varies by jurisdiction. (US: not federally scheduled, banned in 6 states; UK: Psychoactive Substances Act; EU: varies by country; CA: uncontrolled; AU: Schedule 9; banned in Thailand, Malaysia, Myanmar, Denmark, Poland, Sweden, Romania)",
  chemistry: {
    formula:
      "Variable (plant mixture: Mitragyna speciosa - mitragynine, 7-hydroxymitragynine + other alkaloids)",
