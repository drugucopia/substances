...
export const pethidine: Substance = 
{
  "id": "pethidine",
  "name": "Pethidine",
  "commonNames": [
  ...
  "harmReduction": [
    ...
    "As with other opioids, the chronic use of pethidine can be considered extremely addictive with a high potential for abuse and is capable of causing psychological dependence among certain users. When addiction has developed, cravings and may occur if a person suddenly stops their usage.",
