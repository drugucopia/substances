...
export const sufentanil: Substance = 
{
  "id": "sufentanil",
  "name": "Sufentanil",
  "commonNames": [
  ...
  "harmReduction": [
    ...
    "As with other opioids, the chronic use of sufentanil can be considered extremely addictive with a high potential for abuse and is capable of causing psychological dependence among certain users. When addiction has developed, cravings and may occur if a person suddenly stops their usage.",
...
"history": null,
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Sufentanil",
