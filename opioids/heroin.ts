...
export const heroin: Substance = 
{
  ...
  "routeData": {
    "insufflated": {
      ...
      "duration": {
        "onset": "10-60 seconds",
        "comeup": "10-60 seconds",
        "peak": "1-90 minutes",
        "offset": "1-3 hours",
        "total": "3-7 hours",
        "afterglow": "1.5-3 hours"
      }
    },
    "intravenous": {
      "dosage": {
  ...
  "harmReduction": [
    ...
    "Due to the nature of the unregulated drug market, illicit heroin is of widely varying and unpredictable purity. A user may prepare what they consider to be a moderate dose while actually taking far more than intended in the event of obtaining a purer product than they are used to, or may be cut unknowingly with more potent and dangerous substances such as fentanyl. Depending on drug interactions and numerous other factors, death from overdose can take anywhere from several minutes to several hours and is a direct result of respiratory depression leading onto anoxia (oxygen deprivation) resulting from the breathing reflex being suppressed by agonism of µ-opioid receptors. Some sources quote the median lethal dose (for an average 75 kg opiate-naive individual) as being between 75 and 600mg.",
    ...
    "Many opioid drugs, especially oxycodone and heroin, are known to be ototoxic, causing hearing loss, tinnitus and balance issues. In some cases the damage can be irreversible.",
    ...
    "As with other opioids, the chronic use of heroin can be considered extremely addictive with a high potential for abuse and is capable of causing psychological and physical dependence among certain users. When psychological or physical addiction has developed, mental and physical and cravings may occur if a person suddenly stops their usage.",
...
"history": "Alder Wright in 1874 when attempting to combine morphine with various acids. The synthesis was achieved through boiling anhydrous morphine with morphine alkaloid with acetic anhydride. Although the name heroin is a traditional trade name for a Bayer product containing diacetylmorphine, the name has since been widely adopted for all intents and purposes and may describe a recreational depressant that may or may not contain pure diacetylmorphine.",
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Heroin",
