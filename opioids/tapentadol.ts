...
export const tapentadol: Substance = 
{
  "id": "tapentadol",
  "name": "Tapentadol",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Cognitive euphoria - In comparison to other opioids, Tapentadol can be considered as less intense in its cognitive euphoria when compared with that of morphine or heroin.",
    ...
    "neutral": [
      ...
      "Pupil constriction",
      "Dream potentiation",
      "Sleepiness - In high dosages this can get to the point where the user may be drifting in and out of consciousness or even experience what is called \\\"nodding\\\".",
