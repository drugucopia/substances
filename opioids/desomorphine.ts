...
export const desomorphine: Substance = 
{
  "id": "desomorphine",
  "name": "Desomorphine",
  "commonNames": [
  ...
  "harmReduction": [
    ...
    "Causes of this damage include iodine, phosphorus, and leftover solvents like gasoline and paint-thinner that are not adequately removed after synthesis.",
    "Strong acids and bases such as hydrochloric acid and sodium hydroxide are also employed without measuring pH of the final solution.",
    "Failure to remove insoluble fillers and binding aids from the codeine tablets used as starting material, as well as co-administration with pharmaceuticals such as tropicamide and tianeptine, are also cited as possible contributors to the high toxicity observed in users.",
    ...
    "As with other opiate-based painkillers, the chronic use of desomorphine can be considered extremely addictive and is capable of causing both physical and psychological dependence. When physical dependence has developed,  may occur if a person suddenly stops their usage.",
...
"history": "It was originally synthesized with the intention to create an alternative to morphine in terms of tolerance and addiction properties and improve the side effect profile. Notably, the production of Permonid was continued in Switzerland until 1981 due to the idiosyncratic analgesic needs of a single patient in Bern, Switzerland, who suffered from a rare disease. These additives can include hydrochloric acid, red phosphorus (from matchbook striking surfaces), iodine, gasoline, and paint thinner and have been proposed to underly krokodil's severe skin and systemic effects.",
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Desomorphine",
