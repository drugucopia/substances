...
export const dihydrocodeine: Substance = 
{
  "id": "dihydrocodeine",
  "name": "Dihydrocodeine",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Itchiness - This effect is less intense in comparison to codeine.",
