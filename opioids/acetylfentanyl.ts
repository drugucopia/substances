...
export const acetylfentanyl: Substance = 
{
  "id": "acetylfentanyl",
  "name": "Acetylfentanyl",
  "commonNames": [
  ...
  "class": "Anilidopiperidine",
  "description": "Acetylfentanyl is a synthetic opioid substance of the anilidopiperidine chemical class that produces analgesic, anxiety suppressing, and euphoric effects when administered. Studies have estimated acetylfentanyl to be between five to fifteen times more potent than heroin, eighty times more potent than morphine, and fifteen times less potent than its parent compound, fentanyl. Fentanyl analogs have killed hundreds of people throughout Europe and the former Soviet republics since the most recent resurgence in use began in Estonia in the early 2000s.",
  "effects": {
    "positive": [
  ...
  "harmReduction": [
    ...
    "As with other opioids, the chronic use of acetylfentanyl can be considered extremely addictive with a high potential for abuse and is capable of causing psychological dependence among certain users. When addiction has developed, cravings and may occur if a person suddenly stops their usage.",
