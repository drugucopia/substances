...
export const datura: Substance = 
{
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Pupil dilation - Datura blocks receptors in the muscles of the eye that constrict pupil size. This can result in an extreme sensitivity to light which can last for weeks after the experience in certain cases, it also blocks the accommodation reflex, causing vision to be unfocused. Prolonged usage is reputed to cause blindness.",
      ...
      "Bronchodilation",
      "Photosensitivity",
      "Visual acuity suppression - This effect can blur the vision to the point where it can be impossible to read. This blurring of the vision can potentially last for days after the experience.",
      "Double vision",
