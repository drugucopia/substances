...
export const methcathinone: Substance = 
{
  "id": "methcathinone",
  "name": "Methcathinone",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Stimulation - Methcathinone is reported to be extremely stimulating and energetic. The style of stimulation can be described as \\\"forced\\\". This means that at higher doses, it becomes difficult or impossible to keep still as jaw clenching, involuntarily body shakes and vibrations become present.",
...
"history": "Methcathinone was first synthesized in 1928 in the USA and it was used in the Soviet Union as an antidepressant. It is common in central and eastern Europe, often sold as the more well known mephedrone or synthesized from OTC drugs containing ephedrine or pseudoephedrine.",
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Methcathinone",
