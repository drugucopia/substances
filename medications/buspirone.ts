export const buspirone: Substance = 
{
  ...
  "class": "Azapirone",
  "description": "Buspirone is an anxiolytic medication primarily used to treat generalized anxiety disorder (GAD). Unlike benzodiazepines, buspirone acts as a 5-HT1A receptor partial agonist and does not exert its effects through the GABA system. Consequently, it lacks sedative, muscle-relaxant, and anticonvulsant properties, and carries no significant risk of physical dependence or withdrawal. A defining characteristic of buspirone is its delayed onset of therapeutic action; while acute doses reach peak plasma levels quickly, the clinical anxiolytic effects typically require 2 to 4 weeks of daily dosing to fully manifest. It is also used off-label as an augmentation agent for depression.",
  "effects": {
    "positive": [
