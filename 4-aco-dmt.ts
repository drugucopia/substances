...
export const _4_aco_dmt: Substance = 
{
  "id": "4-aco-dmt",
  "name": "4-AcO-DMT",
  "commonNames": [
  ...
  "class": "Substituted tryptamines",
  "description": "4-AcO-DMT is thought to produce its effects by binding to serotonin receptors in the brain; however, the precise mechanism is not known. A paper authored by David E. Nichols in 1999 proposed its potential use as an alternative to psilocybin for pharmacological research due to the lower cost of synthesis. 4-AcO-DMT's classical psychedelic effects and favorable tolerability profile has led it to become popular among novel psychoactive substance users who seek mystical or entheogenic experiences. It is occasionally sold in capsules or pressed pills and marketed as \"synthetic shrooms\". Although its toxicity profile is believed to be near-identical with psilocybin mushrooms, which are known to be physiologically non-toxic, there is no hard data to support this claim.",
  "effects": {
    "positive": [
  ...
  "riskLevel": "moderate",
  "psychonautWikiUrl": "https://psychonautwiki.org/wiki/4-AcO-DMT"
};