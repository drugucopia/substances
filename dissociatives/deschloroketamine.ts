...
export const deschloroketamine: Substance = 
{
  "id": "deschloroketamine",
  "name": "Deschloroketamine",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Visual disconnection - This eventually results in DCK's equivalent of the famous \\\"k-hole\\\" or, more specifically, holes, spaces and voids alongside of structures.",
