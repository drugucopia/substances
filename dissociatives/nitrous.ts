...
export const nitrous: Substance = 
{
  "id": "nitrous",
  "name": "Nitrous",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Neurotoxicity - Long-term or recurrent use of nitrous oxide can result in serious neurological harm.",
  ...
  "harmReduction": [
    ...
    "Medical nitrous oxide has been safely used as a mild anesthetic for over 150 years.",
    "Vapor pressure",
    "Whipped-cream chargers: Very cold temperatures of the gas can freeze the lips and throat if taken directly from a tank or whippet. Releasing the gas into a balloon first allows the gas to warm before being administered.",
    "Medical nitrous oxide is released slowly.",
    "Hypoxia (abnormally low level of oxygen in the tissues), particularly the entity 'diffusion hypoxia'.",
    ...
    "Medical grade nitrous oxide contains 50% nitrous oxide, and 50% oxygen. When used as an anesthetic, nitrous is always administered in combination with oxygen.",
    "Purity",
    "Whipped-cream chargers contains food grade. Thus, they can contain a range of impurities, such as industrial grease left over from manufacturing, and tiny particles of steel from the pierced metal. Users can filter them through a piece of cotton, cloth, or clothing to reduce the amount of impurities inhaled. Regular cleaning of nitrous dispensing devices can also reduce the harm posed by impurities.",
    "Medical grade nitrous oxide: Contains medical grade nitrous oxide.",
    "Direct inhalation",
    "Whipping dispensers is more convenient to fill balloons with than crackers. Direct inhalation of butane can cause frostbite like effects that pose a serious risk of personal injury.",
    "Dangers from plastic whip cream dispensers",
    "It is advised to check that all parts of a whipping dispenser are made of metal, because dispensers made of plastic have exploded and damaged, and albeit extremely rare, even killed people:",
    "In June 2017, Rebecca Burger, 33, a fitness blogger and model, died after a whipped-cream charger exploded and struck her in the chest.",
    "In August 2017, another woman got wounded from a whipping dispenser.",
    "A nitrous charger cracker repeatedly used to decompress cartridges without an outer layer of silicone can cause frostbite.",
...
"history": "Nitrous oxide gas was first synthesized in 1772 by English natural philosopher and chemist Joseph Priestley. He published his findings in the book Experiments and Observations on Different Kinds of Air (1775), describing the synthesis of the gas by heating iron filings dampened with nitric acid. In the book, there is the following passage;\nResearches chemical and philosophical: chiefly concerning nitrous oxide\nDavy notes the analgesic effect of nitrous oxide and its potential for use in surgical operations. In 1863, Gardner Quincy Colton began to administer the gas to patients in all of his \"Colton Dental Association\" clinics, administering nitrous oxide to over 25,000 patients over three years. Nitrous is on the World Health Organization's List of Essential Medicines, the most effective and safe medicines needed in a health system.",
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Nitrous",
