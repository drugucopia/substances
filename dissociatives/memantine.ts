...
export const memantine: Substance = 
{
  "id": "memantine",
  "name": "Memantine",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Auditory distortion",
      "External hallucination (autonomous entities) Even though this effect exists, it's not deliriant and believable unlike other dissociative and deliriant substances."
    ],
    "negative": [
...
"history": null,
  ...
  "riskLevel": "moderate",
  wikipediaUrl: "https://en.wikipedia.org/wiki/Memantine",
