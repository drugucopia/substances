...
export const pce: Substance = 
{
  ...
  "effects": {
    ...
    "negative": [
      ...
      "Psychosis - This effect is more common on PCE than other dissociatives.",
      "Suppression",
      "Hallucinations"
    ]
  },
  ...
  "harmReduction": [
    ...
    "PCE has also been shown to cause schizophrenia-like changes in N-acetylaspartate and N-acetylaspartylglutamate levels in the rat brain, which are detectable both in living rats and upon necropsy examination of brain tissue. It also induces symptoms in humans that mimic schizophrenia.",
    ...
    "PCE is reported to cause psychosis and mania at a significantly higher rate than other dissociatives such as ketamine, diphenidine, or MXE. Multiple scientific papers describe states of psychosis, mania, and/or delirium occurring after moderate to large doses of the drug were ingested. In one initial human trial, it was reported that one-sixth of the patients who had received anesthetic doses became psychotic. In some cases, it took up to a week or more to resolve. Similar results (although less severe) were reported during trials using subanesthetic doses of PCE for pain relief.",
