...
export const ketamine: Substance = 
{
  "id": "ketamine",
  "name": "Ketamine",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Addiction suppression - Ketamine is actively studied as a possible treatment for alcohol use disorder with promising early results.",
    ...
    "negative": [
      ...
      "Increased blood pressure - Shown to occur at higher doses.",
