...
export const _4_ho_met: Substance = 
{
  "id": "4-ho-met",
  "name": "4-HO-MET",
  "commonNames": [
  ...
  "class": "Substituted tryptamines",
  "description": "4-HO-MET was first synthesized by the American chemist Alexander Shulgin, who documented it in his 1997 book TiHKAL (\"Tryptamines I Have Known and Loved\"). Reports of human use began to surface in the late 2000s, following its appearance on the online research chemical market. Users typically describe 4-HO-MET as a more recreational version of psilocybin mushrooms or psilocin (4-HO-DMT) due to its less serious headspace and greater emphasis on visual effects.",
  "effects": {
    "positive": [
...
"history": null,
  ...
  "riskLevel": "moderate",
  "psychonautWikiUrl": "https://psychonautwiki.org/wiki/4-HO-MET"
};