...
export const mescaline: Substance = 
{
  "id": "mescaline",
  "name": "Mescaline",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Existential self-realization - This effect is typically more prevalent in high doses, but can also occur at common doses as well. For a number of users this effect is less repeatable than it is with traditional tryptamines such as psilocin.",
    ...
    "negative": [
      ...
      "Delusion",
      "Memory suppression",
      "Ego death - This component is less consistent and obtainable when compared to other more common psychedelics such as psilocin or LSD. In mescaline's case this effect is highly dose dependent and is also fairly contingent upon the individual's set and setting.",
      "Thought loops",
      "Hallucinations"
    ]
  },
