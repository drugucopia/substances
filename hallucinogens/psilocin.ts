...
export const psilocin: Substance = 
{
  "id": "psilocin",
  "name": "Psilocin",
  "commonNames": [
  ...
  "harmReduction": [
    ...
    "Despite its lack of physical toxicity, however, it is still strongly recommended that one use if choosing to use this substance.",
