...
export const _2c_b: Substance = 
{
  ...
  "effects": {
    "positive": [
      ...
      "Novelty enhancement",
      "Increased libido - Combined with the increased bodily sensations and stimulation, 2C-B is capable of making sexual activity extremely pleasurable.",
    ...
    "negative": [
      ...
      "Anxiety & Paranoia - while possible at most doses, this effect generally occurs at a considerably lower intensity compared to classical psychedelics such as LSD and psilocybin mushrooms.",
      "Delusion",
      "Memory suppression",
      "Ego death",
