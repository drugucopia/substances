...
export const _1cp_lsd: Substance = 
{
  "id": "1cp-lsd",
  "name": "1cP-LSD",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Laughter fits - This can manifest prominently during a 1cP-LSD experience, particularly during the come up phase, often resulting in bouts of uncontrollable giggles and laughter that can form a feedback loop if around others who are also under the influence.",
      "Wakefulness",
