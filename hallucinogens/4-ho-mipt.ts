...
export const _4_ho_mipt: Substance = 
{
  "id": "4-ho-mipt",
  "name": "4-HO-MiPT",
  "commonNames": [
  ...
  "effects": {
    "positive": [
      ...
      "Catharsis",
      "Pain relief - This effect is distinct from pain relief produced by opioids. It appears to manifest itself as a result of changes in how the user perceives their body, rather than direct suppression of pain.",
