...
export const _25i_nbome: Substance = 
{
  "id": "25i-nbome",
  "name": "25I-NBOMe",
  "commonNames": [
  ...
  "effects": {
    ...
    "neutral": [
      ...
      "Muscle contractions",
      "Pupil dilation",
      "Seizures- This effect is far more common in doses exceeding a heavy dose and may manifest as status epilepticus wherein seizures last more than 5 minutes or do not stop without medical intervention",
      "Rhabdomyolysis",
...
"history": null,
  ...
  "riskLevel": "very-high",
  "psychonautWikiUrl": "https://psychonautwiki.org/wiki/25I-NBOMe"
};